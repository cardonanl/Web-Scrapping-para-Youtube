# -*- coding: utf-8 -*-
"""Youtube Scripper.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16iDPiH5wSGwQDHs6kPMf1ZdaNm1Fr2pg
...
API_KEY = "AIzaSyDBVFm1GZnu0wPY8nvnx4k4BN1kT1QgZyU"
channel_id = 'UCkcR6LmTzCs93pmZ76bEy_g'
...
Notese lo siguiente en esta sección. El ForIn para extraer las estadísticas de los videos usa los puntos de información alojados en el archivo .Json. Este puede ser consultado en un explorador web común donde el objeto "video data" contiene cada video alojado como token (ej: "ukNAtIFuJCk"). De manera que si se desea extraer más información, solo se necesita agragar a la lista del blucle.
"""
...
df.to_csv("/content/DF_Matarife.csv", index=True)